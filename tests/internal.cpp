...
//   REQUIRE(AllocateBytes(/*a valid size*/ 100,
//                         /*an alignment less than minimum*/ 2) ==
//                         std::nullopt);
// }
//
...
//
//     std::size_t offset =
//         std::accumulate(begin(chunk_sizes_), begin(chunk_sizes_) + target,
//         0);
//
...
// }
//
// TEST_CASE("FindChunkByFirstFit selects first header even if not optimal
// choice",
//           "[internal/chunk]") {
...
// }
//
// TEST_CASE("CoalesceChunk merges all free adjacent chunks",
// "[internal/chunk]") {
